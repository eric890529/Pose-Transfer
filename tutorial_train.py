...
# resume_path = './checkpoint_for_idea4_all_attnFliter_Classifier_attnOnly/new_exp_sd21_epoch=200_step=744000.ckpt'
#batch_size = 2
logger_freq = 4000
learning_rate = 1e-5
sd_locked = True
...
import os
directory = "checkpoint_for_idea4_all_attnFliter_Classifier_attnOnly_new"
