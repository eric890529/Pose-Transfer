...
resume_path = './checkpoint_for_idea4_all_attnFliter_Classifier_attnOnly_new_lowerProb_12/new_exp_sd21_epoch=138_step=512000.ckpt'
#batch_size = 2
logger_freq = 4000
learning_rate = 1e-5
sd_locked = True
...
import os
directory = "checkpoint_for_idea4_all_attnFliter_Classifier_attnOnly_new_lowerProb_12"
