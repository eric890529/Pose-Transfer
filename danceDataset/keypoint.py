...
class KeyDataset(BaseDataset):
    def initialize(self, opt):
        ...
        self.dir_Region = os.path.join(opt.dataroot, opt.phase + 'R')
    ...
    def __getitem__(self, index):
        ...
        # regions of person 1 and person 2
        Region1_path = os.path.join(self.dir_Region, P1_name + '.npy')
        Region2_path = os.path.join(self.dir_Region, P2_name + '.npy')
        Region1 = np.load(Region1_path)
        Region2 = np.load(Region2_path)

        BP1 = torch.from_numpy(BP1_img).float() #h, w, c
        BP1 = BP1.transpose(2, 0) #c,w,h
        BP1 = BP1.transpose(2, 1) #c,h, 
        ...
        return {'P1': P1, 'BP1': BP1, 'P2': P2, 'BP2': BP2, 'Region1': Region1, 'Region2': Region2,
