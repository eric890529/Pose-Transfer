...
class Dataset(Dataset):
    def __init__(self, opt, is_inference, labels_required = False):
        self.root = opt.path
        self.semantic_path = opt.poseData
        ...
        self.file_path = 'train_pairs.csv' if not is_inference else 'women3Tohiphop_dancerBoy4.csv'
    ...
    def __getitem__(self, index):
        ...
        if self.labels_required:
            target_label_tensor, target_face_center = self.get_label_tensor(path_item['target_label'], target_image_tensor, param)#pose + dist
